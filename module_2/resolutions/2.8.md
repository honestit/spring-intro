**Klasa kontrolera `LoginController`, która obsługę widok:**
...
**Strona jsp `login-page.jsp` zawierająca formularz logowania:**
...
**Zmodyfikowana konfiguracja bezpieczeństwa bazująca na własnym formularzu:**
